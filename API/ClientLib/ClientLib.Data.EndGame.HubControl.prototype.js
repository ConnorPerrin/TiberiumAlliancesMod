...
function GetOwnedTerminalCount(n) {
    var i, t;
    if (this.ZXBHFL.l.length == 0) return 0;
    for (i = 0, t = 0; t < this.ZXBHFL.l.length; t++) this.ZXBHFL.l[t].LDHOTD == n && i++;
    return i
}
...
function GetOccupiedTerminalCount() {
    var t, n;
    if (this.ZXBHFL.l.length == 0) return 0;
    for (t = 0, n = 0; n < this.ZXBHFL.l.length; n++) this.ZXBHFL.l[n] != null && t++;
    return t
}
