...
function setSound anonymous(value) {
    this.$$setSoundImpl.apply(this, arguments);
    return value;
}

function resetSound anonymous(value) {
    var equ = function(a, b) {
        return a === b;
    };
    var prop = qx.core.Property;
    if (this.$$user_sound !== undefined) delete this.$$user_sound;
}

function setRuntimeSound anonymous(value) {
    function set(value) {
        var equ = function(a, b) {
            return a === b;
        };
        var prop = qx.core.Property;
        var old;
        if (this.$$runtime_sound !== undefined) {
            old = this.$$runtime_sound;
        } else if (this.$$user_sound !== undefined) {
            old = this.$$user_sound;
        } else if (this.$$theme_sound !== undefined) {
            old = this.$$theme_sound;
        } else if (this.$$useinit_sound) {
            old = this.$$init_sound;
        }
        this.$$runtime_sound = value;
    }
    var promise;
...
function resetRuntimeSound anonymous(value) {
    var equ = function(a, b) {
        return a === b;
    };
    var prop = qx.core.Property;
    if (this.$$runtime_sound !== undefined) delete this.$$runtime_sound;
}

function setThemedSound anonymous(value) {
    function set(value) {
        var equ = function(a, b) {
            return a === b;
        };
...
function resetThemedSound anonymous(value) {
    var equ = function(a, b) {
        return a === b;
    };
    var prop = qx.core.Property;
    if (this.$$theme_sound !== undefined) delete this.$$theme_sound;
}
