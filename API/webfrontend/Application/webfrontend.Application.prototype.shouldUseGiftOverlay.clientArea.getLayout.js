...
function setDesktop anonymous(value) {
    this.$$setDesktopImpl.apply(this, arguments);
    return value;
}

function resetDesktop anonymous(value) {
    var equ = function(a, b) {
        return a === b;
    };
    var prop = qx.core.Property;
    if (this.$$user_desktop !== undefined) delete this.$$user_desktop;
}

function setRuntimeDesktop anonymous(value) {
    function set(value) {
        var equ = function(a, b) {
            return a === b;
        };
        var prop = qx.core.Property;
        var old;
        if (this.$$runtime_desktop !== undefined) {
            old = this.$$runtime_desktop;
        } else if (this.$$user_desktop !== undefined) {
            old = this.$$user_desktop;
        } else if (this.$$useinit_desktop) {
            old = this.$$init_desktop;
        }
        this.$$runtime_desktop = value;
    }
    var promise;
...
function resetRuntimeDesktop anonymous(value) {
    var equ = function(a, b) {
        return a === b;
    };
    var prop = qx.core.Property;
    if (this.$$runtime_desktop !== undefined) delete this.$$runtime_desktop;
}
