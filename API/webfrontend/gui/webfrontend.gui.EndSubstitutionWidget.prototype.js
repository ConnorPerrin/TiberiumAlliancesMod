...
function open() {
    webfrontend.gui.BackgroundCustomWindow.prototype.open.call(this);
    this.centerPosition()
}

function setOffline(t) {
    this.__bIc.getVisibility() != r && (t = t || !1, this.__bHX.setVisibility(n), this.__bHY.setLabel(this.tr(w)), this.__RN.setValue(this.tr(k)), this.__bIc.show(), t && this.__bIc.setValue(this.tr(tt)))
}