...
function _onClose() {
    webfrontend.phe.cnc.Util.detachNetEvent(ClientLib.Data.MainData.GetInstance().get_Notifications(), d, ClientLib.Data.NotificationAdded, this, this._onNotificationAdded);
    webfrontend.phe.cnc.Util.detachNetEvent(ClientLib.Data.MainData.GetInstance().get_Notifications(), tt, ClientLib.Data.NotificationUpdated, this, this._onNotificationUpdated);
    webfrontend.phe.cnc.Util.detachNetEvent(this.__Et, e, ClientLib.Data.NotificationUnreadCommentCountUpdated, this, this._onNotificationUnreadCommentCountUpdated);
    webfrontend.phe.cnc.Util.detachNetEvent(this.__Et, i, ClientLib.Data.NotificationCommentsDelivered, this, this._onCommentsDelivered);
    webfrontend.phe.cnc.Util.detachNetEvent(this.__Et, o, ClientLib.Data.NotificationHotnessUpdated, this, this._onNotificationHotnessUpdated);
    webfrontend.phe.cnc.Util.detachNetEvent(ClientLib.Data.MainData.GetInstance().get_Forum(), c, ClientLib.Data.ForumThreadsChange, this, this.__Gp)
}
...
function _deferredAppear() {
    var t, n;
    if (this.__ra(), webfrontend.gui.notifications.SingleNotificationPopup.windowXPosStart < 0 || webfrontend.gui.notifications.SingleNotificationPopup.windowYPosStart < 0 || webfrontend.gui.notifications.SingleNotificationPopupManager.numWindowsOpen == 1) t = this.centerPosition(), webfrontend.gui.notifications.SingleNotificationPopup.windowXPosStart = t.x, webfrontend.gui.notifications.SingleNotificationPopup.windowYPosStart = t.y;
    else {
        var u = qx.bom.Viewport.getWidth(window),
            f = qx.bom.Viewport.getHeight(window),
            r = this.getBounds();
        webfrontend.gui.notifications.SingleNotificationPopup.windowXPosStart += 20;
        webfrontend.gui.notifications.SingleNotificationPopup.windowYPosStart += 20;
        (webfrontend.gui.notifications.SingleNotificationPopup.windowXPosStart + r.width > u || webfrontend.gui.notifications.SingleNotificationPopup.windowYPosStart + r.height > f) && (webfrontend.gui.notifications.SingleNotificationPopup.windowXPosStart = 0, webfrontend.gui.notifications.SingleNotificationPopup.windowYPosStart = 0);
        this.moveTo(webfrontend.gui.notifications.SingleNotificationPopup.windowXPosStart, webfrontend.gui.notifications.SingleNotificationPopup.windowYPosStart)
    }
    webfrontend.gui.CustomWindow.prototype._deferredAppear.call(this);
    n = ClientLib.Data.MainData.GetInstance().get_Notifications().GetNotification(this.__FW, this.__FX);
    n != null && this.__Gq(n);
    webfrontend.phe.cnc.Util.attachNetEvent(ClientLib.Data.MainData.GetInstance().get_Notifications(), d, ClientLib.Data.NotificationAdded, this, this._onNotificationAdded);
    webfrontend.phe.cnc.Util.attachNetEvent(ClientLib.Data.MainData.GetInstance().get_Notifications(), tt, ClientLib.Data.NotificationUpdated, this, this._onNotificationUpdated);
    webfrontend.phe.cnc.Util.attachNetEvent(n, e, ClientLib.Data.NotificationUnreadCommentCountUpdated, this, this._onNotificationUnreadCommentCountUpdated);
    webfrontend.phe.cnc.Util.attachNetEvent(n, i, ClientLib.Data.NotificationCommentsDelivered, this, this._onCommentsDelivered);
    webfrontend.phe.cnc.Util.attachNetEvent(n, o, ClientLib.Data.NotificationHotnessUpdated, this, this._onNotificationHotnessUpdated);
    webfrontend.phe.cnc.Util.attachNetEvent(ClientLib.Data.MainData.GetInstance().get_Forum(), c, ClientLib.Data.ForumThreadsChange, this, this.__Gp)
}
...
function _onNotificationUpdated(n, t) {
    this.__Gq(t);
    (this.__Ga != ClientLib.Data.ENotificationCategory.Forum && t.get_Id() == this.__FW || this.__Ga == ClientLib.Data.ENotificationCategory.Forum && t.get_ThreadId() == this.__Gc) && (webfrontend.phe.cnc.Util.detachNetEvent(n, e, ClientLib.Data.NotificationUnreadCommentCountUpdated, this, this._onNotificationUnreadCommentCountUpdated), webfrontend.phe.cnc.Util.detachNetEvent(n, i, ClientLib.Data.NotificationCommentsDelivered, this, this._onCommentsDelivered), webfrontend.phe.cnc.Util.detachNetEvent(n, o, ClientLib.Data.NotificationHotnessUpdated, this, this._onNotificationHotnessUpdated), webfrontend.phe.cnc.Util.attachNetEvent(t, e, ClientLib.Data.NotificationUnreadCommentCountUpdated, this, this._onNotificationUnreadCommentCountUpdated), webfrontend.phe.cnc.Util.attachNetEvent(t, i, ClientLib.Data.NotificationCommentsDelivered, this, this._onCommentsDelivered), webfrontend.phe.cnc.Util.attachNetEvent(t, o, ClientLib.Data.NotificationHotnessUpdated, this, this._onNotificationHotnessUpdated))
}

function _onNotificationUnreadCommentCountUpdated(n) {
    this.__Et == n && (this.__Gd = n.get_NumComments(), this.__Ge = n.get_NumUnreadComments(), this.__Ge > 0 ? this.__Gi.setFont(h) : this.__Gi.setFont(u), this.__Gi.setValue(this.__Gd.toString()))
}

function _onNotificationHotnessUpdated(n) {
    this.__Et == n && this.__Gj != null && this.__Gj.setVisibility(n.get_IsHot() ? t : r)
}

function _onToggleComments() {
    !this.__Gf || this.__Al.isVisible() ? (this.__Al.setVisibility(r), this.__Gn.setIcon(wt), this.__ra()) : (this.__Gr(), this.__Al.setVisibility(t), this.__Gn.setIcon(w), this.__ra())
}

function _onCommentsDelivered(n) {
    var o, s, i, t, r, e;
    if (n != null && this.__Gk != null) {
        if (o = this.__Al.getChildControl(it).getScrollY(), s = o == this.__Al.getChildControl(it).getScrollMaxY(), this.__Gk.removeAll(), this.__Et.get_NumComments() > webfrontend.gui.notifications.SingleNotificationPopup.numCommentsToDisplay && this.__Go < Math.ceil(this.__Et.get_NumComments() / webfrontend.gui.notifications.SingleNotificationPopup.numCommentsToDisplay) && (i = new qx.ui.basic.Label(this.tr(pt)).set({
                textColor: b,
                font: nt,
                width: 562,
                rich: !1,
                textAlign: k,
                paddingRight: 3
            }), i.setCursor(y), i.addListener(f, this.__Gu, this), this.__Gk.add(i)), this.__Ga != ClientLib.Data.ENotificationCategory.Forum)
            for (t = 0; t < n.length; t++) this.__Gk.add(webfrontend.gui.notifications.NotificationsUtil.createCommentEntry(n[t].id, n[t].m, n[t].n, new Date(n[t].t)));
        else
            for (t = 0; t < n.length; t++) this.__Gk.add(webfrontend.gui.notifications.NotificationsUtil.createCommentEntry(n[t].pi, n[t].m, n[t].pn, new Date(n[t].t)));
        this.__Et.get_NumComments() > webfrontend.gui.notifications.SingleNotificationPopup.numCommentsToDisplay && this.__Go > 1 && (r = new qx.ui.basic.Label(this.tr(ri)).set({
            textColor: b,
            font: nt,
            width: 562,
            rich: !1,
            textAlign: k,
            paddingRight: 3
        }), r.setCursor(y), r.addListener(f, this.__Gv, this), this.__Gk.add(r));
        this.__Et.set_NumUnreadComments(0);
        this.__Gi.setFont(u);
        this.__Gi.setValue(this.__Gd.toString());
        s ? (e = new qx.util.DeferredCall(function() {
            this.__Al.scrollChildIntoView(this.__Gl)
        }, this), e.schedule()) : (e = new qx.util.DeferredCall(function() {
            this.__Al.scrollToY(o)
        }, this), e.schedule())
    }
}

function _onKeyPress(t) {
    var r = t.getKeyIdentifier().toLowerCase() == hi,
        u, i;
    t.getTarget().setUserData(n, !r);
    r && (u = this.__FW, i = webfrontend.phe.cnc.gui.util.Text.cleanString(this.__Gm.getValue()), t.isShiftPressed() || (this.__Ga != ClientLib.Data.ENotificationCategory.Forum ? ClientLib.Net.CommunicationManager.GetInstance().SendSimpleCommand(pi, {
        notificationId: u,
        msg: i
    }, webfrontend.phe.cnc.Util.createEventDelegate(ClientLib.Net.CommandResult, this, this._onCommentSubmitted), null) : ClientLib.Net.CommunicationManager.GetInstance().SendSimpleCommand(ut, {
        forumID: this.__Gb,
        threadID: this.__Gc,
        postMessage: i
    }, webfrontend.phe.cnc.Util.createEventDelegate(ClientLib.Net.CommandResult, this, this._onCommentSubmitted), null), t.preventDefault(), this.__Gm.setEnabled(!1)))
}

function _onCommentSubmitted(n, t) {
    if (t != null) {
        var i = qx.core.Init.getApplication();
        t ? (this.__Gm.setValue(i.tr(g)), this.__Gm.setUserData(ci, !0), this.focus()) : i.showSystemMessageError(vi, i.tr(yi))
    }
    this.__Gm.setEnabled(!0)
}