...
function _onClose() {
    this.__bcp.setValue(!1);
    webfrontend.gui.notifications.CategoryPopup.numWindowsOpen--;
    webfrontend.phe.cnc.Util.detachNetEvent(ClientLib.Data.MainData.GetInstance().get_Notifications(), i, ClientLib.Data.NotificationAdded, this, this._onNotificationAdded);
    webfrontend.phe.cnc.Util.detachNetEvent(ClientLib.Data.MainData.GetInstance().get_Notifications(), t, ClientLib.Data.NotificationUpdated, this, this._onNotificationUpdated)
}
...
function _deferredAppear() {
    var n;
    if (webfrontend.gui.CustomWindow.prototype._deferredAppear.call(this), webfrontend.gui.notifications.CategoryPopup.windowXPosStart < 0 || webfrontend.gui.notifications.CategoryPopup.windowYPosStart < 0 || webfrontend.gui.notifications.CategoryPopup.numWindowsOpen == 1) n = this.centerPosition(), webfrontend.gui.notifications.CategoryPopup.windowXPosStart = n.x, webfrontend.gui.notifications.CategoryPopup.windowYPosStart = n.y;
    else {
        var u = qx.bom.Viewport.getWidth(window),
            f = qx.bom.Viewport.getHeight(window),
            r = this.getBounds();
        webfrontend.gui.notifications.CategoryPopup.windowXPosStart += 20;
        webfrontend.gui.notifications.CategoryPopup.windowYPosStart += 20;
        (webfrontend.gui.notifications.CategoryPopup.windowXPosStart + r.width > u || webfrontend.gui.notifications.CategoryPopup.windowYPosStart + r.height > f) && (webfrontend.gui.notifications.CategoryPopup.windowXPosStart = 0, webfrontend.gui.notifications.CategoryPopup.windowYPosStart = 0);
        this.moveTo(webfrontend.gui.notifications.CategoryPopup.windowXPosStart, webfrontend.gui.notifications.CategoryPopup.windowYPosStart)
    }
    webfrontend.phe.cnc.Util.attachNetEvent(ClientLib.Data.MainData.GetInstance().get_Notifications(), i, ClientLib.Data.NotificationAdded, this, this._onNotificationAdded);
    webfrontend.phe.cnc.Util.attachNetEvent(ClientLib.Data.MainData.GetInstance().get_Notifications(), t, ClientLib.Data.NotificationUpdated, this, this._onNotificationUpdated);
    this.__bcr.refreshDisplay()
}
...
function show() {
    this._isActive() || (webfrontend.gui.notifications.CategoryPopup.numWindowsOpen++, webfrontend.gui.CustomWindow.prototype.show.call(this))
}
...
function _onNotificationAdded(n) {
    n.get_CategoryId() == this.__Ga && this.__bcr.refreshDisplay()
}

function _onNotificationUpdated(n, t) {
    t.get_CategoryId() == this.__Ga && this.__bcr.refreshDisplay()
}