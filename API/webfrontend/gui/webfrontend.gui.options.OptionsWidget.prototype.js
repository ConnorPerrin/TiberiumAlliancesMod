...
function onBtnClose() {
    var n = this.getVisibility() == r;
    webfrontend.gui.OverlayWindow.prototype.onBtnClose.call(this);
    n && (this.__bFd(), qx.core.Init.getApplication().showOptionsPage(!0))
}
...
function setSelectedTab(n) {
    this.__yK.getChildren() !== null && n < this.__yK.getChildren().length && this.__yK.setSelection([this.__yK.getChildren()[n]])
}
