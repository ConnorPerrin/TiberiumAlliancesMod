...
function getBrowserMode anonymous() {
    this.getBrowserMode.$$install && this.getBrowserMode.$$install();
    return this.getBrowserMode.apply(this, arguments);
}

function setBrowserMode anonymous() {
    this.setBrowserMode.$$install && this.setBrowserMode.$$install.call(this);
    return this.setBrowserMode.apply(this, arguments);
}
...
function setRuntimeBrowserMode() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, o, arguments)
}

function resetRuntimeBrowserMode() {
