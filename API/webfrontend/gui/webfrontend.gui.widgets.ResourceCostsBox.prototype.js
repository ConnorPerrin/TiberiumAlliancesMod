...
function updateResourceCosts(r, u, f) {
    var o, e;
    if (this.__tP.container.exclude(), this.__tQ.container.exclude(), this.__tR.container.exclude(), this.__tS.container.exclude(), this.__tT.container.exclude(), this.__tU.container.exclude(), f) e = this.__tU, e.container.show(), e.label.setValue(this.tr(i)), e.label.setTextColor(t);
    else
        for (o = 0; o < r.length; o++) {
            ...
            switch (r[o].Type) {
                ...
                case ClientLib.Base.EResourceType.ResearchPoints:
                    e = this.__tT;
                    break;
                case ClientLib.Base.EResourceType.None:
                    e = this.__tU
            }
            e != null && r[o].Count > 0 && (e.container.show(), e.label.setValue(webfrontend.phe.cnc.gui.util.Numbers.formatNumbersCompact(Math.floor(r[o].Count)).toString()), u != null && u.GetResourceCount(r[o].Type) - r[o].Count < 0 ? e.label.setTextColor(t) : e.label.setTextColor(n))
        }
}