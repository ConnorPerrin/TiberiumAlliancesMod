...
function openWithAllianceId(n) {
    ClientLib.Net.CommunicationManager.GetInstance().SendSimpleCommand(fi, {
        id: n
    }, webfrontend.phe.cnc.Util.createEventDelegate(ClientLib.Net.CommandResult, this, this.__NI), null)
}

function openWithAllianceNameOrAbbreviation(n) {
    ClientLib.Net.CommunicationManager.GetInstance().SendSimpleCommand(si, {
        name: n
    }, webfrontend.phe.cnc.Util.createEventDelegate(ClientLib.Net.CommandResult, this, this.__NI), null)
}