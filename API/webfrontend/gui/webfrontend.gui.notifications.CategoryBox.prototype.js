...
function _onClick() {
    this.__bcq == null && (this.__bcq = new webfrontend.gui.notifications.CategoryPopup(this.__Ga, this.__bcp));
    this.__bcq == null || this.__bcq._isActive() ? this.__bcq.close() : this.__bcq.show()
}