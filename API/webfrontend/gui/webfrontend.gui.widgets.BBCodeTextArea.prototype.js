...
function getLegend anonymous(value) {
    if (this.$$runtime_Legend !== undefined) return this.$$runtime_Legend;
    if (this.$$user_Legend !== undefined) return this.$$user_Legend;
    else return this.$$init_Legend;
}

function setLegend anonymous(value) {
    this.$$setLegendImpl.apply(this, arguments);
    return value;
}
...
function setRuntimeLegend() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, o, arguments)
}

function resetRuntimeLegend() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, g)
}

function getWidthBBCodes anonymous(value) {
    if (this.$$runtime_WidthBBCodes !== undefined) return this.$$runtime_WidthBBCodes;
    if (this.$$user_WidthBBCodes !== undefined) return this.$$user_WidthBBCodes;
    else if (this.$$theme_WidthBBCodes !== undefined) return this.$$theme_WidthBBCodes;
    else return this.$$init_WidthBBCodes;
}

function setWidthBBCodes anonymous(value) {
    this.$$setWidthBBCodesImpl.apply(this, arguments);
    return value;
}

function resetWidthBBCodes() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, b)
}

function initWidthBBCodes() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, s, arguments)
}

function setRuntimeWidthBBCodes() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, o, arguments)
}

function resetRuntimeWidthBBCodes() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, g)
}

function setThemedWidthBBCodes() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, f, arguments)
}

function resetThemedWidthBBCodes() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, v)
}

function getMaxTextLength anonymous(value) {
    if (this.$$runtime_MaxTextLength !== undefined) return this.$$runtime_MaxTextLength;
    if (this.$$user_MaxTextLength !== undefined) return this.$$user_MaxTextLength;
    else return this.$$init_MaxTextLength;
}

function setMaxTextLength anonymous() {
    this.setMaxTextLength.$$install && this.setMaxTextLength.$$install.call(this);
    return this.setMaxTextLength.apply(this, arguments);
}

function resetMaxTextLength() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, b)
}

function initMaxTextLength() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, s, arguments)
}

function setRuntimeMaxTextLength() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, o, arguments)
}

function resetRuntimeMaxTextLength() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, g)
}

function getText anonymous() {
    this.getText.$$install && this.getText.$$install();
    return this.getText.apply(this, arguments);
}

function setText anonymous() {
    this.setText.$$install && this.setText.$$install.call(this);
...
function getReadOnly anonymous() {
    this.getReadOnly.$$install && this.getReadOnly.$$install();
    return this.getReadOnly.apply(this, arguments);
}

function setReadOnly anonymous() {
    this.setReadOnly.$$install && this.setReadOnly.$$install.call(this);
    return this.setReadOnly.apply(this, arguments);
}
...
function setRuntimeReadOnly() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, o, arguments)
}

function resetRuntimeReadOnly() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, g)
}