...
function activate(n, r) {
    this._owner = n;
    this._parent = r;
    this.isVisible() ? this._onAppear() : (this._lblTitle.setValue(t), this.addListenerOnce(o, this._onAppear, this), this.setVisibility(i))
}
...
function deactivate() {
    ...
    this.__bvD && this.__bvD.setVisibility(n)
}