...
function updateWindow(n) {
    this.__bJp.scrollToY(0);
    var t = n.get_ResearchTech();
    this.__yS.setValue(n.get_Name());
    t != null ? (this.__bJq.isExcluded() && this.__bJq.show(), this.__bJq.updateWindow(n, t.get_ResourceCosts())) : this.__bJq.show();
    this.__bJD(n);
    this.__bJE(n);
    n.get_ResourceCosts() != null ? (this.__bJC.isExcluded() && this.__bJC.show(), this.__bJC.updateResourceCosts(n.get_ResourceCosts())) : this.__bJC.exclude()
}