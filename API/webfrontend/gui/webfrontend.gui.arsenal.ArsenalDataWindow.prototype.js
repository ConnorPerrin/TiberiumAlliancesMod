...
function getDataWindow anonymous() {
    this.getDataWindow.$$install && this.getDataWindow.$$install();
    return this.getDataWindow.apply(this, arguments);
}

function setDataWindow anonymous() {
    this.setDataWindow.$$install && this.setDataWindow.$$install.call(this);
    return this.setDataWindow.apply(this, arguments);
}

function resetDataWindow() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, b)
}
...
function setRuntimeDataWindow() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, o, arguments)
}

function resetRuntimeDataWindow() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, g)
}

function updateWindow(n) {
    var t = null;
    n.get_PlacementType() == ClientLib.Base.EPlacementType.Offense ? t = this.__bJF : n.get_PlacementType() == ClientLib.Base.EPlacementType.Defense ? t = this.__bJG : n.get_PlacementType() == ClientLib.Base.EPlacementType.Structure && (t = this.__bJH, n.get_ArsenalType() == ClientLib.Data.Arsenal.EArsenalType.SupportBuilding ? t = this.__bJJ : n.get_ArsenalType() == ClientLib.Data.Arsenal.EArsenalType.MCV && (t = this.__bJI));
    t != null && (this.setDataWindow(t), t.updateWindow(n))
}