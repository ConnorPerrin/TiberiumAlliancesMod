...
function _onClose() {
    this.__AV && (webfrontend.data.AllianceEvents.getInstance().removeListener(c, this.__Ru, this), webfrontend.data.AllianceEvents.getInstance().removeListener(h, this.__Rv, this), this.__AV = !1);
...
function show() {
    ...
    this.__AV || (this.__AV = !0, webfrontend.data.AllianceEvents.getInstance().addListener(c, this.__Ru, this), webfrontend.data.AllianceEvents.getInstance().addListener(h, this.__Rv, this));
    this.__Rv()
}
...
function getMarkerId anonymous() {
    this.getMarkerId.$$install && this.getMarkerId.$$install();
    return this.getMarkerId.apply(this, arguments);
}

function setMarkerId anonymous() {
    this.setMarkerId.$$install && this.setMarkerId.$$install.call(this);
    return this.setMarkerId.apply(this, arguments);
}
...
function initMarkerId() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, s, arguments)
}

function setRuntimeMarkerId() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, o, arguments)
}

function resetRuntimeMarkerId() {
