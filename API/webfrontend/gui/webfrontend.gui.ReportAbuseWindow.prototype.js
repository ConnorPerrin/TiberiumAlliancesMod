...
function setup(n, t, i, r, u) {
    ...
    this.__BA = f == er ? webfrontend.gui.ReportAbuseWindow.maxCharcatersEnglish : webfrontend.gui.ReportAbuseWindow.maxCharcatersOther
}
