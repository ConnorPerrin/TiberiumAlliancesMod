...
function deactivate() {
    var n = ClientLib.Vis.VisMain.GetInstance().get_ActiveMouseTool();
    n && n.GetMouseToolType() == ClientLib.Vis.MouseTool.EMouseTool.MoveBuilding || ClientLib.Vis.VisMain.GetInstance().set_SelectedObject(null);
    this.activated = !1
}
...
function activate(n) {
    if (!this.activated) {
        ClientLib.Vis.VisMain.GetInstance().PlayUISound(i);
        this.__bri = n;
        this.setTitle(this.__bri.get_ResourceName());
        switch (this.__bri.get_ResourceType()) {
            case 1:
                this.__brh.setValue(this.tr(u));
                break;
            case 2:
                this.__brh.setValue(this.tr(r))
        }
        this.__brg.setSource(t + n.get_ImageSource());
        this.__brg.setWidth(86);
        this.__brg.setHeight(76);
        this.activated = !0
    }
}
