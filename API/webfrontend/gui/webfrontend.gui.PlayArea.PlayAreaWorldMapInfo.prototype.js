...
function getIsCenterOnCurrentCity anonymous(value) {
    if (this.$$runtime_IsCenterOnCurrentCity !== undefined) return this.$$runtime_IsCenterOnCurrentCity;
    if (this.$$user_IsCenterOnCurrentCity !== undefined) return this.$$user_IsCenterOnCurrentCity;
    else return this.$$init_IsCenterOnCurrentCity;
}

function setIsCenterOnCurrentCity anonymous() {
    this.setIsCenterOnCurrentCity.$$install && this.setIsCenterOnCurrentCity.$$install.call(this);
    return this.setIsCenterOnCurrentCity.apply(this, arguments);
}

function resetIsCenterOnCurrentCity() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, b)
}

function setRuntimeIsCenterOnCurrentCity() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, o, arguments)
}

function resetRuntimeIsCenterOnCurrentCity() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, g)
}

function toggleIsCenterOnCurrentCity anonymous() {
    return this.setIsCenterOnCurrentCity(!this.getIsCenterOnCurrentCity())
}

function isIsCenterOnCurrentCity anonymous() {
    return this.getIsCenterOnCurrentCity()
}
...
function setViewMode(i) {
    ...
    switch (i) {
        case ClientLib.Data.PlayerAreaViewMode.pavmWorldMap:
            r = !0;
            this.getIsCenterOnCurrentCity() && (u = ClientLib.Vis.VisMain.GetInstance().get_World(), u.set_ZoomFactor(2), f = ClientLib.Data.MainData.GetInstance().get_Cities().GetCity(ClientLib.Data.MainData.GetInstance().get_Cities().get_CurrentOwnCityId()), f != null && u.CenterRegionCoordinates((f.get_PosX() + .5) * u.get_GridWidth(), (f.get_PosY() + .5) * u.get_GridHeight()))
    }
    this.__bnf.setVisibility(r ? t : n);
    this.__bnh.setVisibility(r ? t : n);
    this.__bng.setVisibility(r ? t : n);
    r && (this.__bni.setValue(!0), this.__bnj.setValue(!0), this.__bnk.setValue(!0), this.__bnl.setValue(!0), this.__bno.setValue(!1), this.__bnm.setValue(!1), this.__bnn.setValue(!0), this.__bnp.setValue(!0))
}
