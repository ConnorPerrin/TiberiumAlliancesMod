...
function setThemedWidth anonymous(value) {
    function set(value) {
        var equ = function(a, b) {
            return a === b;
        };
        ...
        if (equ.call(this, this.$$theme_width, value)) return value;
        var computed;
        if (this.$$runtime_width !== undefined) {
            computed = this.$$runtime_width;
            this.$$theme_width = value;
        } else if (this.$$user_width !== undefined) {
            computed = this.$$user_width;
            this.$$theme_width = value;
        } else if (this.$$theme_width !== undefined) {
            computed = this.$$theme_width = value;
        } else if (this.$$useinit_width) {
            delete this.$$useinit_width;
            computed = this.$$theme_width = value;
        } else {
            computed = this.$$theme_width = value;
        }
        ...
        var self = this;
        var promise;
        promise = this._applyDimension(computed, old, "width", "setThemed");
