...
function getHeightBar anonymous(value) {
    if (this.$$runtime_HeightBar !== undefined) return this.$$runtime_HeightBar;
    if (this.$$user_HeightBar !== undefined) return this.$$user_HeightBar;
    else return this.$$init_HeightBar;
}

function setHeightBar anonymous() {
    this.setHeightBar.$$install && this.setHeightBar.$$install.call(this);
    return this.setHeightBar.apply(this, arguments);
}

function resetHeightBar() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, b)
}

function initHeightBar() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, s, arguments)
}

function setRuntimeHeightBar() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, o, arguments)
}

function resetRuntimeHeightBar() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, g)
}

function getBackground anonymous(value) {
    if (this.$$runtime_Background !== undefined) return this.$$runtime_Background;
    if (this.$$user_Background !== undefined) return this.$$user_Background;
    else return this.$$init_Background;
}

function setBackground anonymous() {
    this.setBackground.$$install && this.setBackground.$$install.call(this);
    return this.setBackground.apply(this, arguments);
}
...
function setRuntimeBackground() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, o, arguments)
}

function resetRuntimeBackground() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, g)
}

function getForeground anonymous(value) {
    if (this.$$runtime_Foreground !== undefined) return this.$$runtime_Foreground;
    if (this.$$user_Foreground !== undefined) return this.$$user_Foreground;
    else return this.$$init_Foreground;
}

function setForeground anonymous() {
    this.setForeground.$$install && this.setForeground.$$install.call(this);
    return this.setForeground.apply(this, arguments);
}
...
function setRuntimeForeground() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, o, arguments)
}

function resetRuntimeForeground() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, g)
}

function getProgressNormalized anonymous() {
    this.getProgressNormalized.$$install && this.getProgressNormalized.$$install();
    return this.getProgressNormalized.apply(this, arguments);
}

function setProgressNormalized anonymous() {
    this.setProgressNormalized.$$install && this.setProgressNormalized.$$install.call(this);
    return this.setProgressNormalized.apply(this, arguments);
}

function resetProgressNormalized() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, b)
}

function initProgressNormalized() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, s, arguments)
}

function setRuntimeProgressNormalized() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, o, arguments)
}

function resetRuntimeProgressNormalized() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, g)
}
...
function renderLayout(n, t, i, r) {
    qx.ui.container.Composite.prototype.renderLayout.call(this, n, t, i, r);
    this.__bdB && this.__bdD()
}