...
function updateInfo(i) {
    var r = i == null;
    this._techGamedata = null;
    this._researchGameData = null;
    this._researchItem = i;
    r || (this._techGamedata = i.get_GameDataTech_Obj(), this._researchGameData = this._techGamedata.tr, this._researchGameData || (r = !0), this._lblResourceCost != null && (this._getShowResourceCosts() ? this._lblResourceCost.show() : this._lblResourceCost.exclude()));
    this.setVisibility(r ? n : t)
}
