...
function setState(t) {
    ...
    this.__uh = t;
    switch (t) {
        case webfrontend.gui.chat.ChatButtonWidget.state.full:
            this.set({
                minHeight: webfrontend.gui.chat.ChatButtonWidget.dimensionsFull.height,
                height: webfrontend.gui.chat.ChatButtonWidget.dimensionsFull.height,
                maxHeight: webfrontend.gui.chat.ChatButtonWidget.dimensionsFull.height,
                minWidth: webfrontend.gui.chat.ChatButtonWidget.dimensionsFull.width,
                width: webfrontend.gui.chat.ChatButtonWidget.dimensionsFull.width,
                maxWidth: webfrontend.gui.chat.ChatButtonWidget.dimensionsFull.width
            });
            this.__btN.setVisibility(n);
            this.__btW(!0);
            this.__btP.setVisibility(r);
            this.setDecorator((new qx.ui.decoration.Decorator).set({
                backgroundImage: u,
                backgroundRepeat: i
            }));
            break;
        case webfrontend.gui.chat.ChatButtonWidget.state.compact:
            this.set({
                minHeight: webfrontend.gui.chat.ChatButtonWidget.dimensionsCompact.height,
                height: webfrontend.gui.chat.ChatButtonWidget.dimensionsCompact.height,
                maxHeight: webfrontend.gui.chat.ChatButtonWidget.dimensionsCompact.height,
                minWidth: webfrontend.gui.chat.ChatButtonWidget.dimensionsCompact.width,
                width: webfrontend.gui.chat.ChatButtonWidget.dimensionsCompact.width,
                maxWidth: webfrontend.gui.chat.ChatButtonWidget.dimensionsCompact.width
            });
            f.getChat().getVisibility() != n && this.__btW(!0);
            this.__btN.setVisibility(r);
            this.__btP.setVisibility(n);
            this.setDecorator((new qx.ui.decoration.Decorator).set({
                backgroundImage: tt,
                backgroundRepeat: i
            }));
            break;
        case webfrontend.gui.chat.ChatButtonWidget.state.hidden:
            this.__btW(!1)
    }
}

function fadeIn() {
    this.animate(qx.phe.AnimationManager.getInstance().getAnimation(it).getDescription(), null, this.__hG, this)
}

function fadeOut() {
    this.animate(qx.phe.AnimationManager.getInstance().getAnimation(g).getDescription(), null, this.__hG, this)
}
