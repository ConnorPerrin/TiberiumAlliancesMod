...
function _onClose() {
    webfrontend.phe.cnc.Util.detachNetEvent(ClientLib.Data.MainData.GetInstance().get_Reports(), ti, ClientLib.Data.Reports.BaseReportsDelivered, this, this.__Ao);
    webfrontend.phe.cnc.Util.detachNetEvent(ClientLib.Data.MainData.GetInstance().get_Reports(), ii, ClientLib.Data.Reports.TotalUnreadCountUpdated, this, this.__Aq);
    webfrontend.data.AllianceEvents.getInstance().removeListener(k, this.__Ar, this);
    var n = ClientLib.Data.MainData.GetInstance().get_Cities().GetCity(this.__Ab);
    n != null && webfrontend.phe.cnc.Util.detachNetEvent(n, rt, ClientLib.Data.CityChange, this, this.__An)
}
...
function openWithBaseId(n) {
    this.show();
    this._initializeInternal();
    ClientLib.Net.CommunicationManager.GetInstance().SendSimpleCommand(cr, {
        id: n
    }, webfrontend.phe.cnc.Util.createEventDelegate(ClientLib.Net.CommandResult, this, this._onBaseInfo), null)
}

function openWithBaseCoordsId(n) {
    this.show();
    this._initializeInternal();
    ClientLib.Net.CommunicationManager.GetInstance().SendSimpleCommand(kr, {
        id: n
    }, webfrontend.phe.cnc.Util.createEventDelegate(ClientLib.Net.CommandResult, this, this._onBaseInfo), null)
}
...
function _initializeInternal() {
    ...
    this.bringToFront();
    this.__zB();
    webfrontend.phe.cnc.Util.attachNetEvent(ClientLib.Data.MainData.GetInstance().get_Reports(), ti, ClientLib.Data.Reports.BaseReportsDelivered, this, this.__Ao);
    webfrontend.phe.cnc.Util.attachNetEvent(ClientLib.Data.MainData.GetInstance().get_Reports(), ii, ClientLib.Data.Reports.TotalUnreadCountUpdated, this, this.__Aq);
    webfrontend.data.AllianceEvents.getInstance().addListener(k, this.__Ar, this)
}
...
function _onBaseInfo(n, t) {
    var i, r;
    n == !1 || t == null ? (this.__yR.setVisibility(f), this.__zV.setVisibility(u), this.__zi.setVisibility(f), this.__Ac.setEnabled(!1)) : (this.__yR.setVisibility(u), this.__zV.setVisibility(f), this.__yS.setValue(t.n), this.__zT.setCoordinates(t.x, t.y), this.__zY = t.x, this.__Aa = t.y, this.__yT.setValue(webfrontend.phe.cnc.gui.util.Numbers.formatNumbers(t.po)), this.__zU.setPlayer(t.pn.toString(), t.p), this.__yW.setAlliance(t.an, t.a), this.__zW.setBaseId(t.i), this.__zX.setBaseId(t.i), this.__Ab = t.i, this.__zW.reloadData(), this.__zX.reloadData(), this.__zi.setSource(webfrontend.phe.cnc.gui.util.Images.getFactionIconLarge(t.f)), this.__zi.setVisibility(u), this.__Ac.setEnabled(!0), i = ClientLib.Data.MainData.GetInstance().get_Cities().GetCity(this.__Ab), i != null && webfrontend.phe.cnc.Util.attachNetEvent(i, rt, ClientLib.Data.CityChange, this, this.__An), this.__AI());
    r = new qx.util.DeferredCall(function() {
        this._onResize()
    }, this);
    r.schedule()
}