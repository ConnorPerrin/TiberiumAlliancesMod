...
function getTitle anonymous(value) {
    if (this.$$runtime_Title !== undefined) return this.$$runtime_Title;
    if (this.$$user_Title !== undefined) return this.$$user_Title;
    else return null;
}

function setTitle anonymous(value) {
    this.$$setTitleImpl.apply(this, arguments);
    return value;
}
