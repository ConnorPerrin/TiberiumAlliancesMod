...
function getCanWrite anonymous() {
    this.getCanWrite.$$install && this.getCanWrite.$$install();
    return this.getCanWrite.apply(this, arguments);
}

function setCanWrite anonymous() {
    this.setCanWrite.$$install && this.setCanWrite.$$install.call(this);
    return this.setCanWrite.apply(this, arguments);
}

function resetCanWrite() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, b)
}

function initCanWrite() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, s, arguments)
}

function setRuntimeCanWrite() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, o, arguments)
}

function resetRuntimeCanWrite() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, g)
}

function getFilterDeleted anonymous() {
    this.getFilterDeleted.$$install && this.getFilterDeleted.$$install();
    return this.getFilterDeleted.apply(this, arguments);
}

function setFilterDeleted anonymous() {
    this.setFilterDeleted.$$install && this.setFilterDeleted.$$install.call(this);
    return this.setFilterDeleted.apply(this, arguments);
}

function resetFilterDeleted() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, b)
}

function initFilterDeleted() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, s, arguments)
}

function setRuntimeFilterDeleted() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, o, arguments)
}

function resetRuntimeFilterDeleted() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, g)
}

function getGotoPostOfInterest anonymous() {
    this.getGotoPostOfInterest.$$install && this.getGotoPostOfInterest.$$install();
    return this.getGotoPostOfInterest.apply(this, arguments);
}

function setGotoPostOfInterest anonymous() {
    this.setGotoPostOfInterest.$$install && this.setGotoPostOfInterest.$$install.call(this);
    return this.setGotoPostOfInterest.apply(this, arguments);
}

function resetGotoPostOfInterest() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, b)
}

function setRuntimeGotoPostOfInterest() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, o, arguments)
}

function resetRuntimeGotoPostOfInterest() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, g)
}
...
function open(n) {
    webfrontend.data.AllianceEvents.getInstance().addListener(lt, this.__IR, this);
    webfrontend.data.AllianceEvents.getInstance().addListener(ft, this.__IR, this);
    webfrontend.data.AllianceEvents.getInstance().addListener(st, this.__IR, this);
    webfrontend.data.AllianceEvents.getInstance().addListener(l, this.__IR, this);
    webfrontend.phe.cnc.Util.attachNetEvent(ClientLib.Data.MainData.GetInstance().get_Forum(), tt, ClientLib.Data.ForumThreadsChange, this, this.__Gp);
    webfrontend.phe.cnc.Util.attachNetEvent(ClientLib.Data.MainData.GetInstance().get_Forum(), a, ClientLib.Data.ForumThreadPostsFetched, this, this.__LW);
    webfrontend.phe.cnc.Util.attachNetEvent(ClientLib.Data.MainData.GetInstance().get_Forum(), v, ClientLib.Data.ForumThreadPostCountFetched, this, this.__MJ);
    webfrontend.phe.cnc.Util.attachNetEvent(ClientLib.Data.MainData.GetInstance().get_Forum(), ht, ClientLib.Data.ForumThreadsDeleted, this, this.__MK);
    this.setGotoPostOfInterest(!0);
    this.__KF = 0;
    this.setPageContent(this.__tA);
    this.updateThreadData(n, !0);
    this.setVisibility(oi)
}

function close(n) {
    webfrontend.data.AllianceEvents.getInstance().removeListener(lt, this.__IR, this);
    webfrontend.data.AllianceEvents.getInstance().removeListener(ft, this.__IR, this);
    webfrontend.data.AllianceEvents.getInstance().removeListener(st, this.__IR, this);
    webfrontend.data.AllianceEvents.getInstance().removeListener(l, this.__IR, this);
    webfrontend.phe.cnc.Util.detachNetEvent(ClientLib.Data.MainData.GetInstance().get_Forum(), tt, ClientLib.Data.ForumThreadsChange, this, this.__Gp);
    webfrontend.phe.cnc.Util.detachNetEvent(ClientLib.Data.MainData.GetInstance().get_Forum(), a, ClientLib.Data.ForumThreadPostsFetched, this, this.__LW);
    webfrontend.phe.cnc.Util.detachNetEvent(ClientLib.Data.MainData.GetInstance().get_Forum(), v, ClientLib.Data.ForumThreadPostCountFetched, this, this.__MJ);
    webfrontend.phe.cnc.Util.detachNetEvent(ClientLib.Data.MainData.GetInstance().get_Forum(), ht, ClientLib.Data.ForumThreadsDeleted, this, this.__MK);
    this.__Iq.updatePageButtons(0, 0);
    this.setVisibility(pi);
    this.setPageContent(this.__tA);
    this.__MP();
    n && webfrontend.gui.forum.ForumOverlay.getInstance().showInsufficientRightsMessage();
    this.setGotoPostOfInterest(!0)
}
...
function updateThreadData(n, t, i) {
    var f, u, r;
    if (!n) {
        this.close(!0);
        return
    }
    f = !this.__ME || this.__ME.Id != n.Id;
    this.__ME = n;
    u = ClientLib.Data.MainData.GetInstance().get_Forum();
    r = u.get_Forums().d[this.__ME.ForumID];
    r.IsWorldForum ? this.setForumType(webfrontend.gui.forum.ForumTab.ForumTypes.WORLD) : u.IsOwnAllianceForum(this.__ME.ForumID) ? this.setForumType(webfrontend.gui.forum.ForumTab.ForumTypes.MY_ALLIANCE) : this.setForumType(webfrontend.gui.forum.ForumTab.ForumTypes.SHARED_ALLIANCE);
    this.setEForumType(r.eForumType);
    this.__Im.lblforum.setValue(r.Title);
    this.__Im.lblforum.getToolTip().setLabel(r.Description);
    this.__Im.lblthread.setValue(this.__ME.Title);
    this.__Im.lblthread.getToolTip().setLabel(this.__ME.Title);
    this.__Mb.setLabel(this.__ME.IsSticky ? this.tr(gi) : this.tr(ut));
    this.__Mc.setLabel(this.__ME.IsLocked ? this.tr(ir) : this.tr(g));
    i && this.setPageContent(this.__tA);
    this.__IL();
    this.__MI(f)
}
...
function goToLastPage() {
    this.__Iq.setLastPage()
}

function setGoToLastPage(n) {
    this.__KI = n
}

function getIsUnsavedMessage() {
    return this.getPageContent() == this.__Kq ? this.__Kq.getIsUnsavedMessage() : null
}

function doSaveClose() {
    this.getPageContent() == this.__Kq && this.__Kq.doSaveClose()
}

function undoSaveClose() {
    this.getPageContent() == this.__Kq && this.__Kq.undoSaveClose()
}