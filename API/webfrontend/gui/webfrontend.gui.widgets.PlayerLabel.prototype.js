...
function getPlayerId anonymous(value) {
    if (this.$$runtime_playerId !== undefined) return this.$$runtime_playerId;
    if (this.$$user_playerId !== undefined) return this.$$user_playerId;
    else return this.$$init_playerId;
}

function setPlayerId anonymous(value) {
    this.$$setPlayerIdImpl.apply(this, arguments);
    return value;
}
...
function setRuntimePlayerId() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, o, arguments)
}

function resetRuntimePlayerId() {
...
function setFixedContentSize anonymous() {
    this.setFixedContentSize.$$install && this.setFixedContentSize.$$install.call(this);
    return this.setFixedContentSize.apply(this, arguments);
}
...
function setPlayer(n, t, i) {
    var a = !1,
        h, c;
    t > 0 && (h = ClientLib.Data.MainData.GetInstance().get_EndGame().GetWinRankAndFaction(t), h.Faction != ClientLib.Base.EFactionType.NotInitialized && (h.Rank > 0 && h.Rank <= 3 ? this.__RC.setSource(l + h.Rank + u) : (c = f, h.Faction == ClientLib.Base.EFactionType.NODFaction && (c = s), this.__RC.setSource(c)), a = !0));
    this.__RC.setVisibility(a ? v : r);
    this.__yS.setValue(n);
    i ? (this.setPlayerId(-2), this.__yS.setAppearance(o), this.resetCursor()) : (t ? this.setPlayerId(t) : this.setPlayerId(-1), t > 0 || this.getPlayerId() == -1 && n != null && n.length > 0 ? this.setCursor(e) : this.resetCursor(), this.__yS.setAppearance(y))
}
