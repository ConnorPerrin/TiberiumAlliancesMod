...
function show() {
    if (this.getLabel() != null) {
        var r = qx.core.Init.getApplication(),
            i = r.getBackgroundArea().getContentLocation(),
            t = null;
        t = ClientLib.Vis.VisMain.GetInstance().GetTooltipText(this.x - i.left, this.y - i.top);
        t == null || t.length == 0 ? this.setLabel(n) : this.setLabel(t);
        qx.ui.tooltip.ToolTip.prototype.show.call(this)
    }
}
