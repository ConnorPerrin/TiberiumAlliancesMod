...
function deactivate() {
    var i, t;
    this.__bad && (webfrontend.phe.cnc.base.Timer.getInstance().removeListener(et, this.__up, this), i = ClientLib.Data.MainData.GetInstance().get_Cities(), webfrontend.phe.cnc.Util.detachNetEvent(i, l, ClientLib.Data.CitiesChange, this, this.__An), this.__bpD && webfrontend.phe.cnc.Util.detachNetEvent(this.__bpD, l, ClientLib.Data.CityChange, this, this.__bqA), this.__bpU.setSource(n), this.__bpU.exclude(), this.__bpD = null, this.__bqx = null, this.__bpL = !1, this.__bqy = null, this.__bpH = null, t = ClientLib.Vis.VisMain.GetInstance().get_ActiveMouseTool(), t && t.GetMouseToolType() == ClientLib.Vis.MouseTool.EMouseTool.MoveBuilding || ClientLib.Vis.VisMain.GetInstance().set_SelectedObject(null), this.__bad = !1)
}
...
function activate(n) {
    if (!this.__bad) {
        ClientLib.Vis.VisMain.GetInstance().PlayUISound(bt);
        this.__bqx = n;
        this.__bpL = n.get_CityEntityData().HasReachedMaxLevel();
        var t = ClientLib.Data.MainData.GetInstance().get_Cities();
        webfrontend.phe.cnc.Util.attachNetEvent(t, l, ClientLib.Data.CitiesChange, this, this.__An);
        webfrontend.phe.cnc.base.Timer.getInstance().addListener(et, this.__up, this);
        this.__An();
        this.__bad = !0
    }
}
...
function generateResourceGeneralBonus(t) {
    var u = new qx.util.StringBuilder(1024),
        i, r;
    return t == null || t.HideInUI || (i = n, t.IconPath && t.IconPath.length > 0 && (r = new qx.util.StringBuilder(1024), r.add(c, t.IconPath, ct), webfrontend.phe.cnc.res.Main.getInstance().cacheImage(t.IconPath), i = r.get()), u.add(i, t.DisplayName)), u.get()
}