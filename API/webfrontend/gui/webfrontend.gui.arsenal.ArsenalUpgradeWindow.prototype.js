...
function updateWindow(n) {
    var t, i;
    (this.__bJp.scrollToY(0), t = n.get_ResearchTech(), t != null) && (this.__yS.setValue(n.get_Name()), this.__GA.setValue(t.get_Description()), this.__bJl.setValue(t.get_Name()), this.__bJl.setToolTipText(this.tr(ut)), this.__bJm.setSource(f + t.get_SmallPreviewImagePath()), this.__bJr(n), t != null ? (this.__bJq.isExcluded() && this.__bJq.show(), i = t.get_ResourceUpgradeCosts(), i != null && i.length > 0 ? (this.__bJq.updateWindow(n, i), this.__bJn.show()) : this.__bJn.hide()) : this.__bJq.show())
}