...
function getIsShown anonymous() {
    this.getIsShown.$$install && this.getIsShown.$$install();
    return this.getIsShown.apply(this, arguments);
}

function setIsShown anonymous() {
    this.setIsShown.$$install && this.setIsShown.$$install.call(this);
    return this.setIsShown.apply(this, arguments);
}
...
function setIsTimeUpdating anonymous() {
    this.setIsTimeUpdating.$$install && this.setIsTimeUpdating.$$install.call(this);
    return this.setIsTimeUpdating.apply(this, arguments);
}
...
function getCfgChallengeControl anonymous() {
    this.getCfgChallengeControl.$$install && this.getCfgChallengeControl.$$install();
    return this.getCfgChallengeControl.apply(this, arguments);
}

function setCfgChallengeControl anonymous() {
    this.setCfgChallengeControl.$$install && this.setCfgChallengeControl.$$install.call(this);
    return this.setCfgChallengeControl.apply(this, arguments);
}
...
function fadeIn() {
    ...
    this.animate(qx.phe.AnimationManager.getInstance().getAnimation(kt).getDescription(), null, this.__hG, this)
}

function fadeOut() {
    this.setVisibility(n);
    this.animate(qx.phe.AnimationManager.getInstance().getAnimation(li).getDescription(), null, this.__hG, this)
}
...
function checkVisibility() {
    ...
    n ? ClientLib.Data.MainData.GetInstance().get_Server().get_IsSeasonServer() ? this.__buo.getToolTip().setLabel(this.tr(oi, webfrontend.data.ChallengeEvents.getInstance().getName() || di)) : this.__buo.getToolTip().setLabel(this.tr(ki, webfrontend.data.ChallengeEvents.getInstance().getName() || lr)) : (this.__bum.setValue(!1), this.__bun.setValue(!0));
