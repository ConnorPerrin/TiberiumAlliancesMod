...
function _onAppearFake() {
    ...
    this.__bnI();
    this.__bnG = !1;
    this.__bnB.setEnabled(!1);
    this.__bnA.setValue(!1);
    this.__bnH();
    webfrontend.phe.cnc.base.Timer.getInstance().addListener(y, this.__up, this);
    webfrontend.gui.OverlayWindow.prototype._onAppearFake.call(this)
}
...
function deactivate() {
    this.__beB[this.__bnC].img.setToolTip(this.__beB[this.__bnC].toolTip);
    webfrontend.phe.cnc.base.Timer.getInstance().removeListener(y, this.__up, this)
}
