...
function updateWindow(n, t) {
    this.__dS = n;
    n.get_Faction() != ClientLib.Data.MainData.GetInstance().get_Player().get_Faction() ? this.__bJv.exclude() : this.__bJv.show();
    t != null && t.length > 0 && this.__bJw.updateResourceCosts(t, null, !1)
}