...
function setPageListener(n) {
    this.__Jx = n
}

function setCustomAppearance(n, t, i) {
    this.__Am.setDecorator(n);
    this.__Jy.setSource(t);
    this.__Jz.setSource(i)
}
...
function updatePageButtons(n, r) {
    var u, e, f;
    if (this.__JI = n, this.__JJ = r, this.__JI >= this.__JJ && (this.__JI = this.__JJ - 1), r - 4 > n && r > this.__JH ? this.__JD.setVisibility(t) : this.__JD.setVisibility(i), n >= 4 && r > this.__JH ? this.__JC.setVisibility(t) : this.__JC.setVisibility(i), r <= this.__JH)
        for (u = 0; u < this.__JH; u++) u >= r ? this.__JE[u].button.setVisibility(i) : (this.__JE[u].button.setVisibility(t), this.__JE[u].pageIndex = u, this.__JE[u].updateButton());
    else
        for (this.__JE[0].pageIndex = Math.max(this.__JI - 10, 0), e = this.__JJ - 1 - this.__JI, this.__JE[6].pageIndex = e > 10 ? this.__JI + 10 : this.__JI + e, this.__JI < 4 ? (this.__JE[1].pageIndex = 1, this.__JE[2].pageIndex = 2, this.__JE[3].pageIndex = 3, this.__JE[4].pageIndex = 4, this.__JE[5].pageIndex = 5) : this.__JI > this.__JJ - 4 ? (this.__JE[1].pageIndex = this.__JJ - 6, this.__JE[2].pageIndex = this.__JJ - 5, this.__JE[3].pageIndex = this.__JJ - 4, this.__JE[4].pageIndex = this.__JJ - 3, this.__JE[5].pageIndex = this.__JJ - 2) : (this.__JE[1].pageIndex = this.__JI - 2, this.__JE[2].pageIndex = this.__JI - 1, this.__JE[3].pageIndex = this.__JI, this.__JE[4].pageIndex = this.__JI + 1, this.__JE[5].pageIndex = this.__JI + 2), f = 0; f < this.__JE.length; f++) this.__JE[f].button.setVisibility(t), this.__JE[f].updateButton();
    this.__JJ < 2 ? (this.__JB.setEnabled(!1), this.__JA.setEnabled(!1), this.__JF.setEnabled(!1), this.__JG.setEnabled(!1)) : (this.__JB.setEnabled(this.__JI > 0), this.__JA.setEnabled(this.__JI > 0), this.__JF.setEnabled(this.__JI < this.__JJ - 1), this.__JG.setEnabled(this.__JI < this.__JJ - 1));
    this.__JQ()
}

function setLastPage() {
    this.__JI = this.__JJ - 1;
    this.__Jx.onPageChange(this.__JI);
    this.updatePageButtons(this.__JI, this.__JJ)
}
