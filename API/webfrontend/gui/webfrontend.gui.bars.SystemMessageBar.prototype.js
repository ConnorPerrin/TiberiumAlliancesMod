...
function showMessage(n, t) {
    var i, u;
    this.__vR = !0;
    this.__bvz.setValue(t);
    this.__bvz.setTextColor(n);
    this.setVisibility(r);
    i = qx.util.TimerManager.getInstance();
    this.__sC != null && i.stop(this.__sC);
    this.__sC = i.start(this._onAutoClose, null, this, null, 5e3);
    this.__bvB != null && this.__bvB.end();
    u = this.getContentElement().getDomElement();
    u != null && qx.bom.element.Opacity.set(u, 1)
}
