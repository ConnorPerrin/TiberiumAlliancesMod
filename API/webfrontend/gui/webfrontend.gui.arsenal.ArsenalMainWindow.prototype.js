...
function getEntityLevel anonymous() {
    this.getEntityLevel.$$install && this.getEntityLevel.$$install();
    return this.getEntityLevel.apply(this, arguments);
}

function setEntityLevel anonymous() {
    this.setEntityLevel.$$install && this.setEntityLevel.$$install.call(this);
    return this.setEntityLevel.apply(this, arguments);
}

function resetEntityLevel() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, b)
}

function initEntityLevel() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, s, arguments)
}

function setRuntimeEntityLevel() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, o, arguments)
}

function resetRuntimeEntityLevel() {
...
function getCurrentEntityData anonymous() {
    this.getCurrentEntityData.$$install && this.getCurrentEntityData.$$install();
    return this.getCurrentEntityData.apply(this, arguments);
}

function setCurrentEntityData anonymous() {
    this.setCurrentEntityData.$$install && this.setCurrentEntityData.$$install.call(this);
    return this.setCurrentEntityData.apply(this, arguments);
}

function resetCurrentEntityData() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, b)
}

function initCurrentEntityData() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, s, arguments)
}

function setRuntimeCurrentEntityData() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, o, arguments)
}

function resetRuntimeCurrentEntityData() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, g)
}

function getFaction anonymous() {
    this.getFaction.$$install && this.getFaction.$$install();
    return this.getFaction.apply(this, arguments);
}

function setFaction anonymous() {
    this.setFaction.$$install && this.setFaction.$$install.call(this);
    return this.setFaction.apply(this, arguments);
}
...
function setRuntimeFaction() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, o, arguments)
}

function resetRuntimeFaction() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, g)
}

function getInfoType anonymous() {
    this.getInfoType.$$install && this.getInfoType.$$install();
    return this.getInfoType.apply(this, arguments);
}

function setInfoType anonymous() {
    this.setInfoType.$$install && this.setInfoType.$$install.call(this);
    return this.setInfoType.apply(this, arguments);
}

function resetInfoType() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, b)
}

function setRuntimeInfoType() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, o, arguments)
}

function resetRuntimeInfoType() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, g)
}
...
function setCategory anonymous() {
    this.setCategory.$$install && this.setCategory.$$install.call(this);
    return this.setCategory.apply(this, arguments);
}
...
function getUnit anonymous() {
    this.getUnit.$$install && this.getUnit.$$install();
    return this.getUnit.apply(this, arguments);
}

function setUnit anonymous() {
    this.setUnit.$$install && this.setUnit.$$install.call(this);
    return this.setUnit.apply(this, arguments);
}
...
function setRuntimeUnit() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, o, arguments)
}

function resetRuntimeUnit() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, g)
}

function getUnitButton anonymous() {
    this.getUnitButton.$$install && this.getUnitButton.$$install();
    return this.getUnitButton.apply(this, arguments);
}

function setUnitButton anonymous() {
    this.setUnitButton.$$install && this.setUnitButton.$$install.call(this);
    return this.setUnitButton.apply(this, arguments);
}

function resetUnitButton() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, b)
}
...
function setRuntimeUnitButton() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, o, arguments)
}

function resetRuntimeUnitButton() {
    return qx.core.Property.executeOptimizedSetter(this, n, i, g)
}

function open() {
    webfrontend.gui.CustomWindow.prototype.open.call(this);
    this.__em || (this.__em = !0, this.setFaction(ClientLib.Data.MainData.GetInstance().get_Player().get_Faction()), this.setCategory(ClientLib.Data.Arsenal.ArsenalHandler.EArsenalCategory.OffenseInfantry), ClientLib.Data.MainData.GetInstance().get_Player().get_Faction() == ClientLib.Base.EFactionType.GDIFaction ? this.__bIG.setSelection([this.__bIn]) : ClientLib.Data.MainData.GetInstance().get_Player().get_Faction() == ClientLib.Base.EFactionType.NODFaction ? this.__bIG.setSelection([this.__bIo]) : this.__bIG.setSelection([this.__bIp]), this.__bIH.setSelection([this.__bIs]))
}