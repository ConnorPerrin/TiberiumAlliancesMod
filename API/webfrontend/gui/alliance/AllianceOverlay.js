constructor: [Class webfrontend.gui.alliance.AllianceOverlay]
setTab: function(l){switch(l){case webfrontend.gui.alliance.AllianceOverlay.tabs.ETabEnterAlliancePage:this.__LG.setSelection([this.__Mx]);break;case webfrontend.gui.alliance.AllianceOverlay.tabs.ETabOverviewPage:this.__LG.setSelection([this.__My]);break;case webfrontend.gui.alliance.AllianceOverlay.tabs.ETabRosterPage:this.__LG.setSelection([this.__Mz]);break;case webfrontend.gui.alliance.AllianceOverlay.tabs.ETabDiplomacyPage:this.__LG.setSelection([this.__MA]);break;case webfrontend.gui.alliance.AllianceOverlay.tabs.ETabMyInvitationsPage:this.__LG.setSelection([this.__MB]);break;case webfrontend.gui.alliance.AllianceOverlay.tabs.ETabPOI:this.__LG.setSelection([this.__MC]);break;case webfrontend.gui.alliance.AllianceOverlay.tabs.EShieldHub:this.__LG.setSelection([this.__MD]);break;}}
getTab: function(n){var m=null;switch(n){case webfrontend.gui.alliance.AllianceOverlay.tabs.ETabEnterAlliancePage:m=this.__Mx;break;case webfrontend.gui.alliance.AllianceOverlay.tabs.ETabOverviewPage:m=this.__My;break;case webfrontend.gui.alliance.AllianceOverlay.tabs.ETabRosterPage:m=this.__Mz;break;case webfrontend.gui.alliance.AllianceOverlay.tabs.ETabDiplomacyPage:m=this.__MA;break;case webfrontend.gui.alliance.AllianceOverlay.tabs.ETabMyInvitationsPage:m=this.__MB;break;case webfrontend.gui.alliance.AllianceOverlay.tabs.ETabPOI:m=this.__MC;break;case webfrontend.gui.alliance.AllianceOverlay.tabs.EShieldHub:m=this.__MD;break;}return m;}
getCurrentTab: function(){return this.__ME;}
openInvitationsPage: function(){this.open();if(ClientLib.Data.MainData.GetInstance().get_Alliance().get_Exists()&&ClientLib.Data.MainData.GetInstance().get_Player().get_AllianceId()>0){this.setTab(webfrontend.gui.alliance.AllianceOverlay.tabs.ETabMyInvitationsPage);}}
openOverviewPage: function(o){this.open();if(ClientLib.Data.MainData.GetInstance().get_Alliance().get_Exists()&&ClientLib.Data.MainData.GetInstance().get_Player().get_AllianceId()>0){this.setTab(webfrontend.gui.alliance.AllianceOverlay.tabs.ETabOverviewPage);if(o!=null){this.__My.setView(o);}}}
_activate: function(){this.__MF();this.__MG();this.__MH();ClientLib.Data.MainData.GetInstance().get_Player().RefreshMyInvitations();phe.cnc.Util.attachNetEvent(ClientLib.Data.MainData.GetInstance().get_Alliance(),b,ClientLib.Data.AllianceChange,this,this._onAllianceDetailChanged);phe.cnc.Util.attachNetEvent(ClientLib.Data.MainData.GetInstance().get_Player(),h,ClientLib.Data.PlayerChange,this,this._onInvitationsChanged);if(this.__ME&&this.__ME.triggerAppear){this.__ME.triggerAppear();}}
_deactivate: function(){phe.cnc.Util.detachNetEvent(ClientLib.Data.MainData.GetInstance().get_Alliance(),b,ClientLib.Data.AllianceChange,this,this._onAllianceDetailChanged);phe.cnc.Util.detachNetEvent(ClientLib.Data.MainData.GetInstance().get_Player(),h,ClientLib.Data.PlayerChange,this,this._onInvitationsChanged);var p=this.__LG.getSelection();for(var i=0;i<p.length;i++){p[i].deactivate();}if(this.__ME&&this.__ME._onDisappearFake){this.__ME._onDisappearFake();}}
_onAllianceDetailChanged: function(){this.__MF();this.__MH();this.__MC.update();if(this.__MD!=null){this.__MD.update();}}
_onInvitationsChanged: function(){this.__MG();}
_onChangeSelection: function(){if(this.__ME&&this.__ME._onDisappearFake){this.__ME._onDisappearFake();}this.__ME=this.__LG.getSelection()[0];if(this.__ME&&this.__ME.triggerAppear){this.__ME.triggerAppear();}}
__MF: function(){if(ClientLib.Data.MainData.GetInstance().get_Alliance().get_Exists()&&ClientLib.Data.MainData.GetInstance().get_Player().get_AllianceId()>0){if(this.__ME==this.__Mx){this.__LG.remove(this.__Mx);this.__LG.add(this.__My);this.__LG.add(this.__Mz);this.__LG.add(this.__MA);this.__LG.add(this.__MB);this.__LG.add(this.__MC);if(this.__MD!=null){this.__LG.add(this.__MD);}}}else{if(this.__ME!=this.__Mx){this.__LG.add(this.__Mx);this.__LG.remove(this.__My);this.__LG.remove(this.__Mz);this.__LG.remove(this.__MA);this.__LG.remove(this.__MB);this.__LG.remove(this.__MC);if(this.__MD!=null){this.__LG.remove(this.__MD);}}}}
__MG: function(){var q=ClientLib.Data.MainData.GetInstance().get_Player().get_MyInvitations();if(q!=null&&q.length>0){this.__MB.setLabel(this.tr(j)+f+q.length.toString()+e);}else{this.__MB.setLabel(this.tr(j));}}
__MH: function(){this.__MA.updateNumOpenRequests();}
getUIItem: function(r){switch(r){case ClientLib.Data.Missions.PATH.WDG_TABOVERVIEW:return this.__My.getChildControl(g);case ClientLib.Data.Missions.PATH.WDG_EDITDESC:return this.__My.getUIItem(r);}return null;}
getActive: function(){return qx.core.Property.executeOptimizedGetter(this,clazz,name,bk);}
...
getIsFading: function(){return qx.core.Property.executeOptimizedGetter(this,clazz,name,bk);}
setIsFading: function(dr){return qx.core.Property.executeOptimizedSetter(this,clazz,name,e,arguments);}
resetIsFading: function(){return qx.core.Property.executeOptimizedSetter(this,clazz,name,ba);}
setRuntimeIsFading: function(du){return qx.core.Property.executeOptimizedSetter(this,clazz,name,bN,arguments);}
resetRuntimeIsFading: function(){return qx.core.Property.executeOptimizedSetter(this,clazz,name,T);}
__wc: function(s){if(s){this.setIsFading(true);ClientLib.Vis.VisMain.GetInstance().PlayUISound(m);this._activate();this.centerPosition();this.fadeIn();}else{this.__wd();}qx.core.Init.getApplication().getMenuBar().setMenuButtonActive(this.__wb,s);}
__gw: function(){if(!this.getActive()){this._deactivate();var t=qx.core.Init.getApplication().getDesktop();if(t.indexOf(this)!=-1){t.remove(this);}}this.setIsFading(false);}
__wd: function(){this.fadeOut();}
show: function(){qx.ui.container.Composite.prototype.show.call(this);this.setActive(true);}
hide: function(){qx.ui.container.Composite.prototype.hide.call(this);this.setActive(false);}
open: function(){var u=qx.core.Init.getApplication();if(u.getCurrentMenuOverlay()!==this){this.toggle();}}
close: function(){var v=qx.core.Init.getApplication();if(v.getCurrentMenuOverlay()===this){v.switchMenuOverlay(null);}}
toggle: function(){var w=qx.core.Init.getApplication();if(w.getCurrentMenuOverlay()===this){w.switchMenuOverlay(null);}else{w.switchMenuOverlay(this);}this._closeButton.reset();}
centerPosition: function(){var A=qx.core.Init.getApplication();var C=A.getDesktop().getBounds();var B=A.getMenuBar().getBounds();var z=A.getCurrentBottomOverlay();var x=Math.floor((C.width-webfrontend.gui.MenuOverlayWidget.OverlayWidth)/2);var y=B.height;if(z&&z.isVisible()){this.setLayoutProperties({left:x,top:y,bottom:webfrontend.Application.legacySocHeight+webfrontend.gui.notifications.Ticker.TickerHeight});}else{this.setLayoutProperties({left:x,top:y,bottom:webfrontend.gui.notifications.Ticker.TickerHeight});}}
onClose: function(){this.close();}
fadeIn: function(){this.animate(qx.phe.AnimationManager.getInstance().getAnimation(l).getDescription(),null,this.__gw,this);}
fadeOut: function(){this.animate(qx.phe.AnimationManager.getInstance().getAnimation(k).getDescription(),null,this.__gw,this);}
getIsUnsavedMessage: function(){return null;}
doSaveClose: function(){}
undoSaveClose: function(){}
