...
function triggerAppear() {
    this.__GE();
    this.__Os || (webfrontend.phe.cnc.Util.attachNetEvent(ClientLib.Data.MainData.GetInstance().get_Alliance(), s, ClientLib.Data.AllianceChange, this, this._onAllianceDetailChanged), this.__Os = !0)
}

function _onDisappearFake() {
    this.__Os && (webfrontend.phe.cnc.Util.detachNetEvent(ClientLib.Data.MainData.GetInstance().get_Alliance(), s, ClientLib.Data.AllianceChange, this, this._onAllianceDetailChanged), this.__Os = !1)
}
...
function _onClickAcceptRequest() {
    ClientLib.Net.CommunicationManager.GetInstance().SendSimpleCommand(ui, {
        otherAllianceId: this.allianceId
    }, webfrontend.phe.cnc.Util.createEventDelegate(ClientLib.Net.CommandResult, this.form, this.form._onAllianceConfirmRelationshipRequest), null)
}

function _onAllianceConfirmRelationshipRequest(n, t) {
    this.__Vu(n, t)
}

function _onClickDeclineRequest() {
    ClientLib.Net.CommunicationManager.GetInstance().SendSimpleCommand(a, {
        otherAllianceId: this.allianceId
    }, webfrontend.phe.cnc.Util.createEventDelegate(ClientLib.Net.CommandResult, this.form, this.form._onAllianceDeclineRelationshipRequest), null)
}

function _onAllianceDeclineRelationshipRequest(n, t) {
    this.__Vu(n, t)
}

function _onClickWithdrawRequest() {
    ClientLib.Net.CommunicationManager.GetInstance().SendSimpleCommand(pt, {
        otherAllianceId: this.allianceId
    }, webfrontend.phe.cnc.Util.createEventDelegate(ClientLib.Net.CommandResult, this.form, this.form._onAllianceSetRelationshipWithdraw), null)
}

function _onAllianceSetRelationshipWithdraw(n, t) {
    this.__Vu(n, t)
}