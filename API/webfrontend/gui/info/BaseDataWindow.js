constructor: [Class webfrontend.gui.info.BaseDataWindow]
open: function(){this.show();if(this.__DK&&this.__DK.open){this.__DK.open();}}
__bxh: function(){var B=new webfrontend.gui.info.BaseDataOverviewTab(this.tr(a),n);B.getChildControl(e).setToolTipText(this.tr(h));this.__DC.add(B);this.__DK=B;this.__DK.open();var z=new webfrontend.gui.info.BaseDataResourceTab(this.tr(p),m,ClientLib.Base.EResourceType.Tiberium);z.getChildControl(e).setToolTipText(this.tr(c));this.__DC.add(z);var A=new webfrontend.gui.info.BaseDataResourceTab(this.tr(d),k,ClientLib.Base.EResourceType.Crystal);A.getChildControl(e).setToolTipText(this.tr(v));this.__DC.add(A);var y=new webfrontend.gui.info.BaseDataResourceTab(this.tr(q),i,ClientLib.Base.EResourceType.Power);y.getChildControl(e).setToolTipText(this.tr(t));this.__DC.add(y);var C=new webfrontend.gui.info.BaseDataResourceTab(this.tr(g),r,ClientLib.Base.EResourceType.Gold);C.getChildControl(e).setToolTipText(this.tr(u));this.__DC.add(C);this.__DC.addListener(l,this.__qK,this);}
__qK: function(){var D=this.__DK;this.__DK=this.__DC.getSelection().length>0?this.__DC.getSelection()[0]:null;if(D&&D.close&&D!=this.__DK){D.close();}if(this.__DK&&this.__DK.open&&D!=this.__DK){this.__DK.open();}}
getCenterOnShow: function anonymous(value
) {
if(this.$$runtime_centerOnShow!==undefined)return this.$$runtime_centerOnShow;if(this.$$user_centerOnShow!==undefined)return this.$$user_centerOnShow;else return this.$$init_centerOnShow;
}
...
resetActive: function anonymous(value
) {
var prop=qx.core.Property;if(this.$$user_active===undefined)return;var computed, old;if(this.$$runtime_active!==undefined){old=computed=this.$$runtime_active;delete this.$$user_active;}else if(this.$$user_active!==undefined){old=this.$$user_active;delete this.$$user_active;if(this.$$runtime_active!==undefined)computed=this.$$runtime_active;if(this.$$theme_active!==undefined)computed=this.$$theme_active;else if(this.$$init_active!==undefined){computed=this.$$init_active;this.$$useinit_active=true;}}else if(this.$$useinit_active){old=this.$$init_active;}if(computed===undefined)computed=null;if(old===computed)return value;if(old===undefined)old=this.$$init_active;this._applyActive(computed, old, "active", "reset");var reg=qx.event.Registration;if(reg.hasListener(this, 'changeActive')){reg.fireEvent(this, 'changeActive', qx.event.type.Data, [computed, old])}
}
...
getResizableTop: function anonymous(value
) {
if(this.$$runtime_resizableTop!==undefined)return this.$$runtime_resizableTop;if(this.$$user_resizableTop!==undefined)return this.$$user_resizableTop;else return this.$$init_resizableTop;
}
...
getResizableRight: function anonymous(value
) {
if(this.$$runtime_resizableRight!==undefined)return this.$$runtime_resizableRight;if(this.$$user_resizableRight!==undefined)return this.$$user_resizableRight;else return this.$$init_resizableRight;
}
...
getResizableBottom: function anonymous(value
) {
if(this.$$runtime_resizableBottom!==undefined)return this.$$runtime_resizableBottom;if(this.$$user_resizableBottom!==undefined)return this.$$user_resizableBottom;else return this.$$init_resizableBottom;
}
...
getResizableLeft: function anonymous(value
) {
if(this.$$runtime_resizableLeft!==undefined)return this.$$runtime_resizableLeft;if(this.$$user_resizableLeft!==undefined)return this.$$user_resizableLeft;else return this.$$init_resizableLeft;
}
...
getResizeSensitivity: function anonymous(value
) {
if(this.$$runtime_resizeSensitivity!==undefined)return this.$$runtime_resizeSensitivity;if(this.$$user_resizeSensitivity!==undefined)return this.$$user_resizeSensitivity;else return this.$$init_resizeSensitivity;
}
