...
function open(n) {
    var i = ClientLib.Data.MainData.GetInstance().get_Player().get_Faction(),
        t = ClientLib.Res.ResMain.GetInstance().GetPlayerTitleByLevel(i, n);
    this.__bbS.setSource(s + t.bic);
    this.__bbU.setValue(t.dn);
    this.__bbV.setValue(t.dn);
    this.__bbW.setValue(t.dn);
    this.show()
}
