...
function getMessage anonymous() {
    this.getMessage.$$install && this.getMessage.$$install();
    return this.getMessage.apply(this, arguments);
}

function setMessage anonymous() {
    this.setMessage.$$install && this.setMessage.$$install.call(this);
    return this.setMessage.apply(this, arguments);
}
...
function showSystemMessage(t) {
    var r = n,
        o = n,
        h = n,
        i = n;
    t.hasOwnProperty(e) && (r = t.caption);
    t.hasOwnProperty(f) && (o = t.msg);
    t.hasOwnProperty(v) && (h = t.btn);
    t.hasOwnProperty(u) && (i = t.icon);
    this.setCaption(r);
    this.__bEW.setValue(o);
    this.__bEV.setSource(i);
    this.__bEV.setVisibility(i.length > 0 ? s : c);
    this.__bEX.setLabel(h);
    this.open();
    this.center();
    this.bringToFront()
}