...
function setData(t) {
    var o, e, f, c, l, s;
    for (this.__zB(), o = rf + t[ClientLib.Data.Missions.TAG.ID] + ir + t[ClientLib.Data.Missions.TAG.IDSTEP] + lf + (t[ClientLib.Data.Missions.TAG.PREPAREAPP] == undefined ? wf : t[ClientLib.Data.Missions.TAG.PREPAREAPP]) + d + (t[ClientLib.Data.Missions.TAG.STEPS] ? t[ClientLib.Data.Missions.TAG.STEPS].length : 0) + yu, this.__RO.setValue(o), this.__bcy.add(bt, o, h), this.__bcy.add(su), this.__bcz.add(o, st), e = 0; t[ClientLib.Data.Missions.TAG.STEPS] && e < t[ClientLib.Data.Missions.TAG.STEPS].length; ++e) this.__bcy.add(ve, e), f = t[ClientLib.Data.Missions.TAG.STEPS][e], this.__bcy.add(ot, f[ClientLib.Data.Missions.TAG.LABEL] ? it + f[ClientLib.Data.Missions.TAG.LABEL] + it : n, ot), this.__bcz.add(gt, e, bu, f[ClientLib.Data.Missions.TAG.LABEL] ? f[ClientLib.Data.Missions.TAG.LABEL] : n, tu), this.__bcz.add(r), (f[ClientLib.Data.Missions.TAG.PRECONDITIONS] && f[ClientLib.Data.Missions.TAG.PRECONDITIONS].length > 0 || f[ClientLib.Data.Missions.TAG.PREACTIONS] && f[ClientLib.Data.Missions.TAG.PREACTIONS].length > 0) && (this.__bcz.add(fu), this.__bcz.add(r), f[ClientLib.Data.Missions.TAG.PRECONDITIONS] && f[ClientLib.Data.Missions.TAG.PRECONDITIONS].length > 0 && this.__bcP(f[ClientLib.Data.Missions.TAG.PRECONDITIONS]), f[ClientLib.Data.Missions.TAG.PREACTIONS] && f[ClientLib.Data.Missions.TAG.PREACTIONS].length > 0 && this.__bcQ(f[ClientLib.Data.Missions.TAG.PREACTIONS]), this.__bcz.add(u), this.__bcz.add(i)), this.__bcy.add(k), (f[ClientLib.Data.Missions.TAG.PRERUNCONDITIONS] && f[ClientLib.Data.Missions.TAG.PRERUNCONDITIONS].length > 0 || f[ClientLib.Data.Missions.TAG.PRERUNACTIONS] && f[ClientLib.Data.Missions.TAG.PRERUNACTIONS].length > 0) && (this.__bcz.add(ce), this.__bcz.add(r), f[ClientLib.Data.Missions.TAG.PRERUNCONDITIONS] && f[ClientLib.Data.Missions.TAG.PRERUNCONDITIONS].length > 0 && this.__bcP(f[ClientLib.Data.Missions.TAG.PRERUNCONDITIONS]), f[ClientLib.Data.Missions.TAG.PRERUNACTIONS] && f[ClientLib.Data.Missions.TAG.PRERUNACTIONS].length > 0 && this.__bcQ(f[ClientLib.Data.Missions.TAG.PRERUNACTIONS]), this.__bcz.add(u), this.__bcz.add(i)), this.__bcy.add(k), (f[ClientLib.Data.Missions.TAG.CONDITIONS] && f[ClientLib.Data.Missions.TAG.CONDITIONS].length > 0 || f[ClientLib.Data.Missions.TAG.ACTIONS] && f[ClientLib.Data.Missions.TAG.ACTIONS].length > 0) && (this.__bcz.add(li), this.__bcz.add(r), f[ClientLib.Data.Missions.TAG.CONDITIONS] && f[ClientLib.Data.Missions.TAG.CONDITIONS].length > 0 && this.__bcP(f[ClientLib.Data.Missions.TAG.CONDITIONS]), f[ClientLib.Data.Missions.TAG.ACTIONS] && f[ClientLib.Data.Missions.TAG.ACTIONS].length > 0 && this.__bcQ(f[ClientLib.Data.Missions.TAG.ACTIONS]), this.__bcz.add(u), this.__bcz.add(i)), this.__bcy.add(k), f[ClientLib.Data.Missions.TAG.HOLDCONDITIONS] && f[ClientLib.Data.Missions.TAG.HOLDCONDITIONS].length > 0 && (this.__bcz.add(ni), this.__bcz.add(r), f[ClientLib.Data.Missions.TAG.HOLDCONDITIONS] && f[ClientLib.Data.Missions.TAG.HOLDCONDITIONS].length > 0 && this.__bcP(f[ClientLib.Data.Missions.TAG.HOLDCONDITIONS]), this.__bcz.add(u), this.__bcz.add(i)), this.__bcy.add(ei), this.__bcz.add(u);
    if (this.__bcy.add(h), this.__bcz.add(st), this.__bcB.setValue(this.__bcy.get()), this.__bcD.setValue(this.__bcz.get()), c = n, l = uu, this.__bcG.length > 0)
        for (c += hr + this.__bcG.length + di, s = 0; s < this.__bcG.length; ++s) l += af + this.__bcG[s];
    this.__bcA.setValue(c);
    this.__bcA.setToolTipText(l)
}